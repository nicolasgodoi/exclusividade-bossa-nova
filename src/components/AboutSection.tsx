      ...
      >
        ...
        <div style={{ paddingTop: 8 }}>
          ...
          <p style={{
            ...
            Com anos de experiÃÂªncia no mercado imobiliÃÂ¡rio de alto padrÃÂ£o, Rodolfo Andrade une expertise tÃÂ©cnica a um atendimento personalizado e discreto.
          </p>
          <p style={{
            fontFamily: "'Cormorant Garamond', serif",
            ...
            Associado ÃÂ  Bossa Nova Sotheby's International Realty, oferece acesso a um portfÃÂ³lio exclusivo e uma rede global de compradores qualificados.
          </p>
