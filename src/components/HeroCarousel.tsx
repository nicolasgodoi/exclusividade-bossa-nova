...
const IMAGES = [
  ...
  { src: {`${import.meta.env.BASE_URL}images/IMG_0325.jpg`}, label: 'SuÃÂ­te Master' },
];
  ...
  return (
    <div style={{ background: '#1C2B3A', position: 'relative', width: '100%', overflow: 'hidden' }}>
      <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden' }}>
        ...
        {/* Subtle top fog Ã¢ÂÂ blends into white sections below */}
        <div style={{
        ...
        {/* Bottom fade Ã¢ÂÂ transitions to white */}
        <div style={{
        ...
        <nav style={{
          ...
          {/* Nav links Ã¢ÂÂ desktop only */}
          {!isMobile && (
            <div style={{ display: 'flex', gap: 36 }}>
              {[['#detalhes', 'O ImÃÂ³vel'], ['#localizacao', 'LocalizaÃÂ§ÃÂ£o'], ['#sobre', 'Corretor'], ['#contato', 'Contato']].map(([href, label]) => (
          ...
          <span style={{
            ...
            {String(activeIndex + 1).padStart(2, '0')} ÃÂ· {String(IMAGES.length).padStart(2, '0')}
          </span>
        </nav>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 400 }}>
            <p style={{
              ...
              Bossa Nova Sotheby's ÃÂ· ImÃÂ³vel de Alto PadrÃÂ£o
            </p>
            <p style={{
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {(['prev', 'next'] as const).map(dir => (
                <button
                  ...
                  aria-label={dir === 'prev' ? 'Anterior' : 'PrÃÂ³ximo'}
                  style={{
